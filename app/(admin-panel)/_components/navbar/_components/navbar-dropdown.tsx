  ...
  const items: MenuProps["items"] = [
    {
      ...
      label: (
        <button
          className="bg-none w-full text-left cursor-pointer"
          onClick={async () => {
  ...
  return (
    ...
    >
      <Flex
        ...
        justify="center"
        gap={15}
        className="!bg-[#136ae317] hover:!bg-[#136ae32a] transition-colors duration-200 !w-fit !px-[6px] rounded-full cursor-pointer"
      >
        <Avatar
